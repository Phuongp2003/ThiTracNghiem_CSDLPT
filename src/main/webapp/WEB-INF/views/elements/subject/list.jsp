	...
	<table class="subject-list table">
		<div class="filter-wrapper row mb-2">
			...
			<div class="col-md-6 col-sm-6 col-lg-6">
				<a href="manage/category/add-category"><button type="button" class="btn btn-outline-primary">Thêm môn học</button></a>
				<a href="manage/category/add-category"><button type="button" class="btn btn-outline-primary">Undo</button></a>
				<a href="manage/category/add-category"><button type="button" class="btn btn-outline-primary">In danh sách môn học</button></a>
			</div>
		</div>
		<thead>
			<tr>
